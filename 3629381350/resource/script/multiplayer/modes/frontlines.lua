...
local SpawnCooldownTime = {
	AttackerMin = 5 * 1000, -- 5 sec (ms)
	AttackerMax = 10 * 1000, -- 10 sec (ms)
	DefenderMin = 6 * 1000, -- 6 sec (ms)
	DefenderMax = 12 * 1000, -- 12 sec (ms)
}
local UnitSpawnWaitTime = 30 * 1000 -- 30 sec (ms) Sets time limit AI will wait for a unit it has chosen to buy if the unit is not yet available
...
local OrderRotationTime = {
	Attacker = 45 * 1000, -- 45 sec (ms)
	Defender = 2 * 60000, -- 2 min (ms)
}
